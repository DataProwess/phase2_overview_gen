                ...
                if ($Item.PSIsContainer) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            # Write-ErrorLog -UNCPath $uncPath -ProblemPath $Item.FullName -ErrorMessage "Failed to retrieve file owner" -ForegroundColor DarkYellow
                            Write-Log "File: $Item.FullName - Owner retrieval failed, continuing with other fields" -ForegroundColor DarkYellow
                        }
